...
export const RELEASES: Release[] = [
  {
    ...
    date: '2026-07-19',
    changes: [
      'Cálculo para artilheiro (palpites especiais) Regulamento 1 atualizado.',
    ],
  },
  {
    version: '2.0.22',
  ...
  },
  {
    ...
    date: '2026-07-15',
    changes: [
      'Exportação de relatório temporariamente desabilitada para usuários normais (disponível apenas para admins)',
    ],
  },
  {
    version: '2.0.19',
  ...
  },
  {
    ...
    date: '2026-07-05',
    changes: [
      'Melhorias no layout para mata-mata',
    ],
  },
  {
    version: '2.0.9',
    date: '2026-07-05',
    changes: [
      'Adaptações para o Regulamento 2',
    ],
  },
  {
    version: '2.0.8',
  ...
  },
  {
    ...
    date: '2026-07-03',
    changes: [
      'Ajustes de layout para palpites especiais',
      'Correção da bandeira para times que não foram definidos ainda',
    ],
  },
  {
    version: '2.0.3',
