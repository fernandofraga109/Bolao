---
description: Commitar mudanças no repo local e no repo do Miguel usando Claude Code
---

# Workflow: Commitar em Ambos os Repositórios no Claude Code

Este workflow automatiza o processo de commitar mudanças no seu repositório e no repositório do Miguel quando estiver usando o Claude Code dentro da pasta `.claude`.
