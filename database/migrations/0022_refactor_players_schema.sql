-- Migration 0022: Refactor players schema — split identity from competition/team context
-- Date: 2026-06-05
-- Safe: data will be re-synced after migration

DROP TABLE IF EXISTS v2_tournament_players CASCADE;
...
CREATE TABLE v2_tournament_players (
    id                  uuid PRIMARY KEY DEFAULT gen_random_uuid(),
