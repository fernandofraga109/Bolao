    ...
    <div className="min-h-screen bg-brand-dark flex flex-col items-center justify-center p-4">
      <div className="bg-slate-800 p-8 rounded-2xl shadow-2xl w-full max-w-md border border-slate-700 text-center animate-fadeIn relative">
        ...
        <div className="flex justify-center mb-6">
          <div className="relative">
            <AvatarWithFallback
              ...
              fallbackClassName="bg-slate-700 text-brand-green"
              iconSize={26}
            />
        ...
        <p className="text-slate-400 mb-8 text-sm">
          Para começar, você precisa fazer parte de um bolão.
        </p>
        ...
        {mode !== "menu" && (
          <div className="animate-slideIn">
            ...
            <input
              ...
              placeholder={
                mode === "create" ? "Ex: Bolão da Família" : "Ex: COPA26"
              }
            ...
            <DualActionButtons
              ...
              primaryClassName="flex-1 bg-brand-green hover:bg-emerald-400 text-slate-900 font-bold py-3 px-4 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              secondaryClassName="flex-1 py-3 rounded-xl bg-slate-700 hover:bg-slate-600 text-slate-300 font-bold text-sm transition-colors"
            />
          </div>
        )}
      </div>
