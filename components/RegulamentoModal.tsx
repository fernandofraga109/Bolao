...
H) Acertar previamente (antes da copa) qual a seleção que tomará o maior número de gols em uma única partida - 20 (Não precisa dizer o número de gols e nem o jogo).
...
4) Não haverá, em qualquer hipótese, qualquer tipo de arrego para aquele que perder o prazo das apostas, independentemente do motivo alegado. Não haverá submissão à votação dos demais para esse tipo de flexibilização.
Entretanto, quem perder o prazo, poderá ainda apostar, desde que as apostas dos demais ainda não tenham sido divulgadas e o jogo ou jogos em questão ainda não tenham iniciado. Haverá também uma penalização de 3 pontos por jogo esquecido, em caso de acerto naquele jogo, até o máximo de 40 pontos de penalização, em caso de a aposta envolver mais jogos.

5) Quem apostar errado não poderá alegar erro material / engano. Dane-se.
...
D) As datas limites dos palpites serão informadas oportunamente.

E) Ninguém, em nenhum momento, poderá alegar desconhecimento das regras previstas neste Regulamento.`;
